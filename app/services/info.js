...
export async function saveInfoReview(params) {
    return request(`http://118.24.107.177:7001/info/saveReview`, {
        method: "POST",
        body: params,
    })
  }
...
export async function saveInfoDraft(params) {
    return request(`http://118.24.107.177:7001/info/saveDraft`, {
        method: "POST",
        body: params,
    })
  }
...
export async function draftInfo(params) {
    return request(`http://118.24.107.177:7001/info/draft`, {
        method: "POST",
        body: params,
    })
  }
...
export async function reviewInfo(params) {
    return request(`http://118.24.107.177:7001/info/review`, {
        method: "POST",
        body: params,
    })
  }
...
export async function deleteInfo(params) {
    return request(`http://118.24.107.177:7001/info/delete`, {
        method: "POST",
        body: params,
    })
  }
...
export async function getInfoList(params) {
    return request(`http://118.24.107.177:7001/info/own/list`, {
        method: "POST",
        body: params,
    })
  }
...
export async function getInfoListById(params) {
    return request(`http://118.24.107.177:7001/info/own/classify/list`, {
        method: "POST",
        body: params,
    })
  }
